...
import { getCart, addToCart, updateCartItem, removeFromCart, createOrderController, verifyPayment } from "../controller/cart.controller.js";
...
router.post("/payment/verify/order", identifyUser , verifyPayment)
